...
const ContentChapterMobile: React.FC<ContentChapterProps> = ({
  ...
  return (
    <main className="flex flex-col justify-center items-center mx-auto w-full bg-white mt-5  ">
      {/* panel 1 */}
      <section className="w-full flex flex-col min-h-screen">
        ...
        >
          ...
          <div className="absolute bottom-8 left-0 w-full text-center z-10 pointer-events-none">
            ...
            <p className="font-sans text-[10px] mt-2 tracking-widest text-white drop-shadow-md">
        ...
        <main
          id="teks"
          className="px-5 py-12 flex flex-col items-center text-center bg-white"
        >
          <h1 className="text-gray-400 text-xs font-sans mb-6 uppercase tracking-widest">
            {data.chapter}.
          </h1>

          <p className="font-serif text-[35px] uppercase leading-[0.9] mb-8 text-black/80 tracking-tight">
            {data.firstSection.maintext}
          </p>

          <p className="font-sans text-xs leading-4 text-justify text-gray-600 max-w-md">
      ...
      {/* panel 2 */}
      <section className="w-full h-[80vh] relative bg-gray-100 shrink-0 items-center justify-center flex">
        <Image
      ...
      {/* panel 3 */}
      <section className="w-full py-16 px-6 flex flex-col gap-12 bg-white shrink-0">
        <main id="gambar" className="w-full flex flex-col">
          <div className="w-full aspect-square relative shadow-sm bg-gray-50">
            <Image
        ...
        <main id="text" className="text-center px-2">
          <h1 className="font-serif text-[35px] uppercase leading-[0.85] mb-6 text-black/80 tracking-tight">
      ...
      {/* panel 4 */}
      <section className="w-full py-16 px-6 bg-white  shrink-0">
        <div className="mb-10 text-center">
          <h1 className="font-serif text-[35px] uppercase leading-[0.85] tracking-tight text-black/80 text-center">
            {data.fourthSection.mainText}
          </h1>
        </div>
        <div className="flex flex-col gap-4">
          <main id="gambar" className="w-full">
            <div className="w-full aspect-square relative bg-gray-200 shadow-sm mb-4">
              <Image
            ...
            <div className="flex gap-8 items-start">
              ...
              <p className="font-serif text-xs leading-tight text-black/80">
